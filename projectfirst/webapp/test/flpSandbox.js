		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#firstprojectfirst-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstprojectfirst-display": {
								"semanticObject": "firstprojectfirst",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=first.projectfirst",
									"url": sap.ui.require.toUrl("first/projectfirst")
								}
							}
						}
					}
